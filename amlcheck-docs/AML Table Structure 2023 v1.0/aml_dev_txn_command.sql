...
CREATE TABLE `txn_command` (
  ...
  `contact_no` varchar(1) DEFAULT NULL,
  `gender` varchar(1) DEFAULT NULL,
  `identification_type` varchar(1) DEFAULT NULL,
  `identification_no` varchar(1) DEFAULT NULL,
  `res_addr_room` varchar(1) DEFAULT NULL,
  `res_addr_floor` varchar(1) DEFAULT NULL,
  `res_addr_block` varchar(1) DEFAULT NULL,
  `res_addr_lot` varchar(1) DEFAULT NULL,
  `res_addr_building_name` varchar(45) DEFAULT NULL,
  `res_addr_street` varchar(36) NOT NULL,
  `res_addr_village` varchar(1) DEFAULT NULL,
  `res_addr_housing_project` varchar(1) DEFAULT NULL,
  ...
  `com_add_country_code` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2023-02-14 18:11:04
